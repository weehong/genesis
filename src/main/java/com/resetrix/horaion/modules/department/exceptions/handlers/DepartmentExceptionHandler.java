package com.resetrix.horaion.modules.department.exceptions.handlers;
...
@RestControllerAdvice(basePackages = "com.resetrix.horaion.modules.department")
public class DepartmentExceptionHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentExceptionHandler.class);
