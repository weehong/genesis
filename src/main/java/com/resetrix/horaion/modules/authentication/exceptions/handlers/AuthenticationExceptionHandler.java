...
@RestControllerAdvice(basePackages = "com.resetrix.horaion.modules.authentication")
public class AuthenticationExceptionHandler {
    ...
    public ProblemDetail handleUsernameExistsException(UsernameExistsException ex,
                                                        HttpServletRequest request) {
        LOGGER.warn("UsernameExistsException for request {}: {}", request.getRequestURI(), ex.getMessage());
        ...
        error.put("message", "An account with this email address already exists");
