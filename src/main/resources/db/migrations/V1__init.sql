...
INSERT INTO
    companies (name, registration_number, logo, soft_delete)
SELECT
    'Google Singapore',
    '200605367W',
    decode(
...
WHERE
    NOT EXISTS (
        ...
        FROM
            companies
        WHERE
            registration_number = '200605367W'
    );
...
SELECT
    ...
    '117371',
    '+65-6531-5000',
    'singapore@google.com'
FROM
    companies c
WHERE
    c.registration_number = '200605367W'
    AND NOT EXISTS (
        SELECT
            1
        FROM
