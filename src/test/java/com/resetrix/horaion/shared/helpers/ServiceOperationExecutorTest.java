...
import com.resetrix.horaion.modules.company.exceptions.InvalidFileException;
import com.resetrix.horaion.shared.exceptions.FeignServiceException;
...
class ServiceOperationExecutorTest {
    ...
    @Test
    void execute_shouldExecuteThrowStatementForEntityNotFoundExceptionInSaveContext() {
        // Given - Direct EntityNotFoundException to trigger line 54: throw handleEntityNotFoundException(ex, context);
        EntityNotFoundException cause = new EntityNotFoundException("Entity not found");
        Supplier<String> operation = () -> {
            throw cause;
        };
        String context = "save operation"; // Non-retrieval context
    ...
    @Test
    void execute_shouldExecuteThrowStatementForJpaSystemExceptionInUpdateContext() {
        // Given - Direct JpaSystemException to trigger line 64: throw handleJpaSystemException(ex, context);
        JpaSystemException cause = new JpaSystemException(new RuntimeException("JPA system error"));
        Supplier<String> operation = () -> {
            throw cause;
        };
        String context = "update operation"; // Non-save context
    ...
    @Test
    void execute_shouldExecuteThrowStatementForPersistenceExceptionInUpdateContext() {
